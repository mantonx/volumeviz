...
const longPath: BreadcrumbItem[] = [
  ...
  {
    name: 'Projects',
    path: '/users/john/documents/work/projects',
    isClickable: true,
  },
  {
    name: 'VolumeViz',
    path: '/users/john/documents/work/projects/volumeviz',
    isClickable: true,
  },
  {
    name: 'Frontend',
    path: '/users/john/documents/work/projects/volumeviz/frontend',
    isClickable: true,
  },
  {
    name: 'src',
    path: '/users/john/documents/work/projects/volumeviz/frontend/src',
    isClickable: true,
  },
  {
    name: 'components',
    path: '/users/john/documents/work/projects/volumeviz/frontend/src/components',
    isClickable: false,
  },
];
...
const veryLongPath: BreadcrumbItem[] = [
  { name: 'Root', path: '/', isClickable: true },
  {
    name: 'very-long-folder-name-that-exceeds-normal-lengths',
    path: '/very-long-folder-name-that-exceeds-normal-lengths',
    isClickable: true,
  },
  {
    name: 'another-extremely-long-folder-name',
    path: '/very-long-folder-name-that-exceeds-normal-lengths/another-extremely-long-folder-name',
    isClickable: true,
  },
  {
    name: 'deeply-nested-subfolder-with-long-name',
    path: '/very-long-folder-name-that-exceeds-normal-lengths/another-extremely-long-folder-name/deeply-nested-subfolder-with-long-name',
    isClickable: true,
  },
  {
    name: 'final-destination-folder',
    path: '/very-long-folder-name-that-exceeds-normal-lengths/another-extremely-long-folder-name/deeply-nested-subfolder-with-long-name/final-destination-folder',
    isClickable: false,
  },
];
...
export const MixedClickability: Story = {
  args: {
    items: [
      ...
      {
        name: 'Current',
        path: '/protected/system/logs/current',
        isClickable: false,
      },
    ],
    onItemClick: (path) => console.log('Clicked path:', path),
