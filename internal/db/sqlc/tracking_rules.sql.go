...
INSERT INTO tracking_rules (
    ...
    $1, $2, $3, $4, $5, $6, $7
) RETURNING id, name, description, action, priority, is_enabled, conditions, match_count, last_matched_at, last_evaluation_at, created_by, created_at, updated_at, organization_id
`
...
SELECT id, name, description, action, priority, is_enabled, conditions, match_count, last_matched_at, last_evaluation_at, created_by, created_at, updated_at, organization_id FROM tracking_rules
WHERE id = $1
`
