...
type HardDeleteVolumeParams struct {
	VolumeID       string      `json:"volume_id"`
	OrganizationID pgtype.Int8 `json:"organization_id"`
}
...
func (q *Queries) HardDeleteVolume(ctx context.Context, arg HardDeleteVolumeParams) error {
	_, err := q.db.Exec(ctx, hardDeleteVolume, arg.VolumeID, arg.OrganizationID)
	return err
}
