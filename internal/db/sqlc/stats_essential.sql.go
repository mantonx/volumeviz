...
INSERT INTO daily_stats (
    ...
    $4, $5, $6,
    $7, $8, $9
) RETURNING id, volume_id, date, total_size_bytes, size_change_bytes, growth_percent, total_files, new_files, deleted_files, modified_files, media_files, document_files, code_files, archive_files, other_files, scan_duration_ms, created_at, disk_total_bytes, disk_available_bytes
`
...
func (q *Queries) CreateDailyStat(ctx context.Context, arg CreateDailyStatParams) (DailyStats, error) {
	...
	err := row.Scan(
		...
		&i.CreatedAt,
		&i.DiskTotalBytes,
		&i.DiskAvailableBytes,
	)
	return i, err
}

const getDailyStatsForDate = `-- name: GetDailyStatsForDate :many
SELECT id, volume_id, date, total_size_bytes, size_change_bytes, growth_percent, total_files, new_files, deleted_files, modified_files, media_files, document_files, code_files, archive_files, other_files, scan_duration_ms, created_at, disk_total_bytes, disk_available_bytes FROM daily_stats 
