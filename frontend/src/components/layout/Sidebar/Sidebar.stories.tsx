        ...
        <div className="lg:pl-72 p-8">
          <div className="max-w-4xl">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              This represents the main application content. The sidebar is
              positioned on the left and pushes content to the right on desktop
              views.
            </p>
          </div>
        </div>
...
export const Mobile: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Sidebar behavior on mobile devices with overlay and close button.',
      },
    },
  },
};
...
export const Desktop: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Sidebar behavior on desktop where it's always visible and doesn't overlay content.",
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Fully interactive sidebar with state management and route navigation.',
      },
    },
  },
};
...
export const StatsPanel: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Focus on the quick stats panel functionality at the bottom of the sidebar.',
      },
    },
  },
};
