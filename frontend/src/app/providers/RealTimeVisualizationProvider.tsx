...
> = ({ children, options = {} }) => {
  ...
  // Real-time scanning hook (application-specific)
  const realTimeScans = useRealTimeScans(defaultOptions);

  // Visualization data transformation hook (application-specific)
 ...
 * Only works within the application that provides this context
 */
