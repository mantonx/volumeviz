...
CREATE INDEX IF NOT EXISTS idx_volumes_labels_gin ON volumes USING GIN(labels);
CREATE INDEX IF NOT EXISTS idx_volumes_options_gin ON volumes USING GIN(options);
...
CREATE INDEX IF NOT EXISTS idx_containers_labels_gin ON containers USING GIN(labels);
...
CREATE INDEX IF NOT EXISTS idx_system_health_metadata_gin ON system_health USING GIN(metadata);
