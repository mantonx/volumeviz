...
describe('Toast', () => {
  ...
  describe('Variants', () => {
    it('renders info variant with correct icon', () => {
      ...
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-variant', 'info');
    });
    ...
    it('renders success variant with correct icon', () => {
      ...
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-variant', 'success');
    });
    ...
    it('renders warning variant with correct icon', () => {
      ...
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-variant', 'warning');
    });
    ...
    it('renders error variant with correct icon', () => {
      ...
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-variant', 'error');
    });
  });
  ...
  describe('Sizes', () => {
    it('renders small size', () => {
      ...
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-size', 'sm');
    });

    it('renders medium size', () => {
      render(<Toast {...defaultProps} size="md" />);
      
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-size', 'md');
    });

    it('renders large size', () => {
      render(<Toast {...defaultProps} size="lg" />);
      
      expect(screen.getByTestId('test-toast')).toHaveAttribute('data-size', 'lg');
    });
  });
