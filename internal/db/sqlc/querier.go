...
type Querier interface {
	...
	CountUnenrichedFiles(ctx context.Context, volumeID string) (int64, error)
	...
	GetUnenrichedFilesPaginated(ctx context.Context, arg GetUnenrichedFilesPaginatedParams) ([]Files, error)
