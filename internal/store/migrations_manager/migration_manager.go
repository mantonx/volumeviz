// Package migrations_manager provides migration management for schema evolution
...
// MigrationHistory represents an applied migration in the database
...
func NewMigrationManager(db *config.DB) *MigrationManager {
